...
public class Tiles {
    ...
    public static final TileConfig VOID = new TileConfig(VOID_ID, Wall$.MODULE$);
    ...
    public final static TileConfig ROOM_WALL = new TileConfig(ROOM_WALL_ID, Wall$.MODULE$);
...
//	public final static TileConfiguration ROOM_WALL_SE = new TileConfiguration("room.wall.se", false, true);
    ...
    public final static TileConfig ROOM_GROUND = new TileConfig(ROOM_GROUND_ID, Ground$.MODULE$);
    public final static TileConfig ORB = new TileConfig(ROOM_GROUND_ID, Ground$.MODULE$);


    public static final TileConfig DOOR_OPENED = new TileConfig(DOOR_OPENED_ID, Ground$.MODULE$);
    public static final TileConfig DOOR_CLOSED = new TileConfig(DOOR_CLOSED_ID, Wall$.MODULE$);
